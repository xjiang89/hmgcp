...
b = mat['b']
b = S.variable(b.reshape((b.shape[0],)))
...
q0 = mat['q0']
q0 = S.variable(q0.reshape((q0.shape[0],)))

mat = sio.loadmat('../input_data/q1.mat')
q1 = mat['q1']
q1 = S.variable(q1.reshape((q1.shape[0],)))

mat = sio.loadmat('../input_data/q2.mat')
q2 = mat['q2']
q2 = S.variable(q2.reshape((q2.shape[0],)))

mat = sio.loadmat('../input_data/r1.mat')
r1 = mat['r1']
r1 = S.variable(r1.reshape((r1.shape[0],)))

mat = sio.loadmat('../input_data/r2.mat')
r2 = mat['r2']
r2 = S.variable(r2.reshape((r2.shape[0],)))
